    ...
    "projects":
        [
            {
                ...
                "description": "Deep learning model to perform two deimensional pose estimation and identify the ankle, proximal interphalangeal joint and toe to understand lower leg kinematics.",
                "awards": "",
                "image_link": img0,
                "is_report": "0",
            ...
            },
            {
                ...
                "tags": ["CAD", "CFD"],
                "description": "Iterative design process of a recreational cycling helmet using SolidWorks and Complutational fluid dynamic analysis of the same. The CFD anaylsis uses steady Reynolds-Averaged Navier–Stokes (RANS) equations using a k-ω shear stress transport (SST) model ",
                "awards": "",
                "image_link": img3,
                "is_report": "1",
                "report_link": file3,
            ...
            },
            {
                ...
                "description": "Study conducted to prove the concurrent validity of step frequency calculated by OptoJump based on data collecetd from six participants. Using a bland altman plot and  inter calss correlation reported the validity of Optojump system.",
                "awards": "",
                "image_link": img4,
                "is_report": "1",
                "report_link": file4,
        ...
        ,
            ...
            },
            {
                ...
                "description": "Developed a system to detect eye lid motion to study driver drowsiness. In addition, explored usage of gyroscope and accelerometer sensor to control motion of a remote controlled car.",
                "awards": "",
                "image_link": img9,
                "is_report": "",
                "report_link": "",
